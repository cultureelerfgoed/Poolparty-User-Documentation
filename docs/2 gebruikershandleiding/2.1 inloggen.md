...
**1. de gebruikersnaam** en het **2. eenmalig te gebruiken wachtwoord** gebruiken die je hebt ontvangen via thesauri@cultureelerggoed.nl.
...
**3** Bij de eerste keer inloggen word je gevraagd om je wachtwoord te wijzigen. Zorg ervoor dat je een veilig wachtwoord aanmaakt en dit goed noteert.  
