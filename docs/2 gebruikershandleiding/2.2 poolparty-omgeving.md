...
![Image](icon05.png) **Lijst met projecten waarvoor de gebruiker toegangsrechten heeft.**
...
![Image](icon01.png) Door in het hoofdmenu op **Project** en vervolgens op ![Image](icon02.png) **Open Project** te klikken, verschijnt een keuzemenu waarin je een project kunt selecteren.

![Image](icon03.png) In het startmenu kun je ook een project openen door:
