...
<img id="zoomImage" src="customscheme05.png" alt="Project Image" style="max-width: 90%; max-height: 90%; cursor: zoom-out;" onclick="closeZoom()" />
</div>
<img src="customscheme05.png" alt="Project Image" style="width: 800px; cursor: zoom-in;" onclick="openZoom()" />
...
**2.a** Als je een custom scheme wil maken van een core ontology of custom ontology, rechter-muis-klick op de Ontology's node in de boom diagram, die zich bevindt onder **Core Ontologies** or **Custom Ontologies** en selecteer **New Custom Scheme** op de context menu. 

**2.b** Als je een Custom Scheme wil maken vanuit een Custom Ontology, selecteer de desbetreffende ontologie in de **Hierarchy Tree** en klik op **New Custom Scheme** link rechts.
